    ...
    if (isset($_POST['utilizador']) && isset($_POST['palavra_passe'])) {
        ...
        if ($result->num_rows == 1) {
            ...
            if ($_SESSION['tipo'] == 'admin') {
                header("Location: ../admin/index.php"); // Caminho absoluto para a pasta admin
            } else {
                header("Location: ./index.php"); // Caminho absoluto para a pasta user
            }
            exit();
        } else {
...
<body>
    ...
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="container">
        ...
        <div class="form-group">
            ...
            <p>Ainda não estás registado ? <a href="regista_user.php" class="button">Registar</a></p>
        </div>
    </form>
</body>
</html>

...
// Verifica se o parâmetro 'referencia' está presente na URL
if (isset($_GET['referencia'])) {
    // Obtém o ID do imóvel da URL
    $id_imovel = $_GET['referencia'];

    // Consulta SQL para selecionar as informações do imóvel com base no ID
    $consulta = "SELECT * FROM imobiliaria WHERE referencia = $id_imovel";
